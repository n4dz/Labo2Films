...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + TABLE_FILMS+ " ('code', 'titre', 'codecateg', 'langue', 'cote', 'pochette') VALUES (1125, 'Le dernier empereur', 1, 'FR', 4, '2131230948');");
        db.execSQL("INSERT INTO " + TABLE_FILMS+ " ('code', 'titre', 'codecateg', 'langue', 'cote', 'pochette') VALUES (1279, 'Ére de glace', 2, 'FR', 5, '2131230950');");
        db.execSQL("INSERT INTO " + TABLE_FILMS+ " ('code', 'titre', 'codecateg', 'langue', 'cote', 'pochette') VALUES (1486, 'ET', 2, 'AN', 5, '2131230949');");
        ...
        values.put("cote", "5");
        values.put("pochette", "2131230947");
